...
list_source_drivers() {
  ...
  info "USB4 Virtual power coordination device [] -> In-Kernel"
  info "Microsoft Surface ACPI-Compliant Control Method Battery [BATTERY] -> In-Kernel"
  info "Intel(R) Wireless Bluetooth(R) [BLUETOOTH] -> In-Kernel; Firmware Required"
  info "Integrated Camera [CAMERA] -> In-Kernel"
  info "Intel(R) AI Boost [COMPUTEACCELERATOR] -> In-Kernel; Firmware Required"
  info "Intel(R) Graphics [DISPLAY] -> In-Kernel; Firmware Required"
  info "NVIDIA GeForce RTX 5070 Ti Laptop GPU [DISPLAY] -> Kernel Module (DKMS); Proprietary Driver"
  info "Logicool HID Keyboard Consumer Controls [HIDCLASS] -> In-Kernel"
  info "Logicool HID Keyboard Power Key [HIDCLASS] -> In-Kernel"
  info "USB Input Device [HIDCLASS] -> In-Kernel"
  info "USB Input Device [HIDCLASS] -> In-Kernel"
  info "USB Input Device [HIDCLASS] -> In-Kernel"
  info "USB Input Device [HIDCLASS] -> In-Kernel"
  info "USB Input Device [HIDCLASS] -> In-Kernel"
  info "USB Input Device [HIDCLASS] -> In-Kernel"
  info "Logitech HID-Compliant Keyboard [KEYBOARD] -> In-Kernel"
  info "Awinic Smart Amplifier Driver for Speakers [MEDIA] -> In-Kernel"
  info "NVIDIA High Definition Audio [MEDIA] -> In-Kernel"
  info "Realtek High Definition Audio(SST) [MEDIA] -> In-Kernel"
  info "Lenovo DisplayHDR [MONITOR] -> Not Applicable"
  info "Logicool HID-compliant Cordless Mouse [MOUSE] -> In-Kernel"
  info "Intel(R) Ethernet Controller I226-V [NET] -> In-Kernel"
  info "Intel(R) Wi-Fi 7 BE200 320MHz [NET] -> In-Kernel; Firmware Required"
  info "Standard NVM Express Controller [SCSIADAPTER] -> In-Kernel"
  info "Standard NVM Express Controller [SCSIADAPTER] -> In-Kernel"
  info "NVIDIA Platform Controllers and Framework [SOFTWAREDEVICE] -> In-Kernel; Generic Driver"
  info "Error Aggregation Handler (EAH) - 7F2F [SYSTEM] -> In-Kernel; Generic Driver"
  info "LPC Controller/eSPI Controller - 7F0C [SYSTEM] -> In-Kernel"
  info "SPI (flash) Controller - 7F24 [SYSTEM] -> In-Kernel; Generic Driver"
  info "High Definition Audio Controller [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Innovation Platform Framework Generic Participant [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Innovation Platform Framework Manager [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Innovation Platform Framework Processor Participant [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Innovation Platform Framework SMBUS Device [SYSTEM] -> In-Kernel"
  info "Intel(R) Management Engine Interface #1 [SYSTEM] -> In-Kernel"
  info "Intel(R) Platform Monitoring Technology (PMT) Driver [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Serial IO GPIO Host Controller - INTC1082 [SYSTEM] -> In-Kernel"
  info "Intel(R) Serial IO GPIO Host Controller - INTC1084 [SYSTEM] -> In-Kernel"
  info "Intel(R) Serial IO I2C Host Controller - 7F4C [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Serial IO I2C Host Controller - 7F4D [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Serial IO I2C Host Controller - 7F4E [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Serial IO I2C Host Controller - 7F7A [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Serial IO I2C Host Controller - 7F7B [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) SPI (flash) Controller - AE23 [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel(R) Watchdog Timer Driver (Intel(R) WDT) [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel® Smart Sound Technology BUS [SYSTEM] -> In-Kernel; Generic Driver"
  info "Intel® Smart Sound Technology OED [SYSTEM] -> In-Kernel; Generic Driver"
  info "Lenovo ACPI-Compliant Virtual Power Controller [SYSTEM] -> In-Kernel; Generic Driver"
  info "Lenovo Dispatcher [SYSTEM] -> In-Kernel; Generic Driver"
  info "Lenovo Fn and function keys [SYSTEM] -> In-Kernel; Generic Driver"
  info "PCI Express Root Port [SYSTEM] -> In-Kernel"
  info "PCI Express Root Port [SYSTEM] -> In-Kernel"
  info "PCI Express Root Port [SYSTEM] -> In-Kernel"
  info "PCI Express Root Port [SYSTEM] -> In-Kernel"
  info "PCI Express Root Port [SYSTEM] -> In-Kernel"
  info "PCI Express Root Port [SYSTEM] -> In-Kernel"
  info "PCI standard host CPU bridge [SYSTEM] -> In-Kernel; Generic Driver"
  info "PCI standard ISA bridge [SYSTEM] -> In-Kernel; Generic Driver"
  info "PCI standard RAM Controller [SYSTEM] -> In-Kernel; Generic Driver"
  info "USB Composite Device [USB] -> In-Kernel"
  info "USB Composite Device [USB] -> In-Kernel"
  info "USB Composite Device [USB] -> In-Kernel"
  info "USB Composite Device [USB] -> In-Kernel"
  info "USB Root Hub (USB 3.0) [USB] -> In-Kernel"
  info "USB Root Hub (USB 3.0) [USB] -> In-Kernel"
  info "USB xHCI Compliant Host Controller [USB] -> In-Kernel"
  info "USB xHCI Compliant Host Controller [USB] -> In-Kernel"
  info "USB4(TM) Host Router (Microsoft) [USB] -> In-Kernel"
  info "WinUsb Device [USBDEVICE] -> In-Kernel"
  info "WinUsb Device [USBDEVICE] -> In-Kernel"
  info "(0 additional devices are covered by the drivers built into macOS.)"
}
