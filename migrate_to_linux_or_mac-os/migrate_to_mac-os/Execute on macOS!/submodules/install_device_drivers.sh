...
list_source_drivers() {
  ...
  info "Microsoft Surface ACPI-Compliant Control Method Battery [BATTERY] -> Not Applicable"
  info "Intel(R) AI Boost [COMPUTEACCELERATOR] -> Not Supported"
  info "NVIDIA GeForce RTX 5070 Ti Laptop GPU [DISPLAY] -> Not Supported"
  info "Lenovo DisplayHDR [MONITOR] -> Not Applicable"
  info "(66 additional devices are covered by the drivers built into macOS.)"
}
