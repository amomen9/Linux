...
#
#  Universal installer: detects the Linux distribution family (apt/dnf/pacman/
#  zypper/apk/emerge/slackpkg -- most-popular-first) and CPU architecture at runtime,
#  then installs each app Flatpak-first with a native-package fallback.  Runs
#  unchanged on every supported distro.
# =============================================================================
# =============================================================================
