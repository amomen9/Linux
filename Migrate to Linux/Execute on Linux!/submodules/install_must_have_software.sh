...
repo_setup_microsoft_edge() {
  ...
  app_alt 1 3 0 95 install_app --name "Copilot" --alt "Copilot (Web/PWA)" --method webapp --webapp "https://copilot.microsoft.com" --dlpage "https://copilot.microsoft.com" --note "auto-guessed install from the alternative name (unverified)"
  app_alt 2 3 1 90 install_app --name "Copilot" --alt "Claude Desktop (community Linux build)" --method manual --dlpage "https://github.com/aaddrick/claude-desktop-debian/releases" --note "Unofficial community native build (.deb/.rpm/AppImage/AUR/Nix, or the claudeai-desktop Snap). Not built or supported by Anthropic; the official supported Linux option is the Claude Code CLI (npm install -g @anthropic-ai/claude-code)."
  app_alt 3 3 1 60 install_app --name "Copilot" --alt "Ollama + Continue.dev" --method script --script-url "https://ollama.com/install.sh" --dlpage "https://ollama.com/" --note "Installs Ollama via its official script (curl -fsSL https://ollama.com/install.sh | sh): adds the ollama CLI + a systemd service. Then add the Continue extension in VS Code and point it at the local Ollama backend."
  wine_app "Copilot" "" "" ""
  ...
  app_alt 1 2 1 100 install_app --name "pgAdmin" --alt "pgAdmin 4 (Desktop)" --method native --apt "pgadmin4-desktop" --dnf "pgadmin4-desktop" --dlpage "https://www.pgadmin.org/download/" --note "From the official pgAdmin repo. Web mode (pgadmin4-web) is also available."
  app_alt 2 2 1 90 install_app --name "pgAdmin" --alt "DBeaver Community" --method flatpak --flatpak "io.dbeaver.DBeaverCommunity" --dlpage "https://dbeaver.io/"
  ...
  app_alt 1 2 1 90 install_app --name "Python Launcher" --alt "python3 (system interpreter)" --method native --apt "python3" --dnf "python3" --zypper "python3" --pacman "python" --dlpage "https://www.python.org/" --note "Preinstalled on most distros; installed here only if missing."
  ...
  app_alt 1 3 0 95 install_app --name "Claude" --alt "Claude (Web/PWA)" --method webapp --webapp "https://claude.ai" --dlpage "https://claude.ai" --note "auto-guessed install from the alternative name (unverified)"
  app_alt 2 3 1 70 install_app --name "Claude" --alt "Ollama + Open WebUI" --method script --script-url "https://ollama.com/install.sh" --dlpage "https://ollama.com/" --note "Installs Ollama via its official script (curl -fsSL https://ollama.com/install.sh | sh): adds the ollama CLI + a systemd service. Pull a model afterwards, e.g. 'ollama run llama3'. Open WebUI is a separate optional frontend (run it via Docker: ghcr.io/open-webui/open-webui)."
  app_alt 3 3 1 65 install_app --name "Claude" --alt "Jan" --method native --dlpage "https://jan.ai/" --note "auto-guessed install from the alternative name (unverified)"
  ...
  app_alt 1 2 1 88 install_app --name "Python Manager" --alt "pyenv (Python version manager)" --method script --github "pyenv/pyenv" --script-url "https://pyenv.run" --dlpage "https://github.com/pyenv/pyenv" --note "Installs pyenv to ~/.pyenv. Build deps needed to compile CPython versions."
  app_alt 2 2 1 82 install_app --name "Python Manager" --alt "python3 (system interpreter)" --method native --apt "python3" --dnf "python3" --zypper "python3" --pacman "python" --dlpage "https://www.python.org/"
  wine_app "Python Manager" "" "" ""
