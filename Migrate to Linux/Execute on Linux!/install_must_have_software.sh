...
main() {
  ...
  install_app --name "Anaconda3" --alt "Anaconda (Linux)" --method manual --url-x86 "https://www.anaconda.com/download" --note "Download the Anaconda installer .sh and run it"
  ...
  install_app --name "ChemDraw / ChemOffice" --alt "MarvinSketch (MarvinSuite)" --method manual --url-x86 "https://chemaxon.com/products/marvin" --note "MarvinSuite from chemaxon.com"
  ...
  install_app --name "Foxit PDF Reader / Editor" --alt "Foxit PDF Reader (Linux)" --method manual --url-x86 "https://www.foxit.com/pdf-reader/" --note "Foxit Reader for Linux (.run installer)"
  ...
  install_app --name "Gurobi" --alt "Gurobi (Linux)" --method manual --url-x86 "https://www.gurobi.com/downloads/" --note "Gurobi Optimizer (academic/commercial) from gurobi.com"
  ...
  install_app --name "Mathcad / PTC Mathcad Prime" --alt "SMath Studio" --method manual --url-x86 "https://en.smath.com/view/SMathStudio/summary" --note "SMath Studio (free) from smath.com"
  ...
  install_app --name "Microsoft Project" --alt "ProjectLibre" --method manual --url-x86 "https://www.projectlibre.com/" --note "ProjectLibre (.deb/.rpm) from projectlibre.com"
  ...
  install_app --name "PaperCut Print Deploy Client" --alt "PaperCut Print Deploy (Linux)" --method manual --note "PaperCut Print Deploy client from your print server's portal"
  ...
  install_app --name "RealVNC Viewer" --alt "RealVNC Viewer (Linux)" --method manual --url-x86 "https://www.realvnc.com/en/connect/download/viewer/" --note "RealVNC Viewer (.deb/.rpm)"
  ...
  install_app --name "RStudio" --alt "RStudio (Linux)" --method manual --url-x86 "https://posit.co/download/rstudio-desktop/" --note "RStudio Desktop (.deb/.rpm) from posit.co"
  install_app --name "Rufus" --alt "Ventoy" --method manual --url-x86 "https://github.com/ventoy/Ventoy/releases" --note "Ventoy from ventoy.net; GUI alt: 'popsicle'"
  ...
  install_app --name "SpotPlayer" --alt "SpotPlayer (Linux)" --method manual --note "SpotPlayer (Sib) Linux build from sibm[a].ir"
  ...
  install_app --name "VMware Workstation" --alt "VMware Workstation Pro (Linux)" --method manual --url-x86 "https://www.vmware.com/products/workstation-pro.html" --note "VMware Workstation Pro .bundle (free for personal use)"
  ...
  install_app --name "WindTerm" --alt "WindTerm (Linux)" --method manual --url-x86 "https://github.com/kingToolbox/WindTerm/releases" --note "WindTerm from GitHub releases"
