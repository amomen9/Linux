...
MANUAL_APPS=(
  "Anaconda3|Download the Anaconda installer .sh and run it"
  "ChemDraw / ChemOffice|MarvinSuite from chemaxon.com"
  "Foxit PDF Reader / Editor|Foxit Reader for Linux (.run installer)"
  "Gurobi|Gurobi Optimizer (academic/commercial) from gurobi.com"
  "Mathcad / PTC Mathcad Prime|SMath Studio (free) from smath.com"
  "Microsoft Project|ProjectLibre (.deb/.rpm) from projectlibre.com"
  "PaperCut Print Deploy Client|PaperCut Print Deploy client from your print server's portal"
  "RealVNC Viewer|RealVNC Viewer (.deb/.rpm)"
  "RStudio|RStudio Desktop (.deb/.rpm) from posit.co"
  "Rufus|Ventoy from ventoy.net; GUI alt: 'popsicle'"
  "SpotPlayer|SpotPlayer (Sib) Linux build from sibm[a].ir"
  "VMware Workstation|VMware Workstation Pro .bundle (free for personal use)"
  "WindTerm|WindTerm from GitHub releases"
)
