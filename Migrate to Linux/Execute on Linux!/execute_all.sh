...
MANUAL_APPS=(
  "Anaconda3|Anaconda (Linux) - Download the Anaconda installer .sh and run it"
  "ChemDraw / ChemOffice|MarvinSketch (MarvinSuite) - MarvinSuite from chemaxon.com"
  "Foxit PDF Reader / Editor|Foxit PDF Reader (Linux) - Foxit Reader for Linux (.run installer)"
  "Gurobi|Gurobi (Linux) - Gurobi Optimizer (academic/commercial) from gurobi.com"
  "Mathcad / PTC Mathcad Prime|SMath Studio - SMath Studio (free) from smath.com"
  "Microsoft Project|ProjectLibre - ProjectLibre (.deb/.rpm) from projectlibre.com"
  "PaperCut Print Deploy Client|PaperCut Print Deploy (Linux) - PaperCut Print Deploy client from your print server's portal"
  "RealVNC Viewer|RealVNC Viewer (Linux) - RealVNC Viewer (.deb/.rpm)"
  "RStudio|RStudio (Linux) - RStudio Desktop (.deb/.rpm) from posit.co"
  "Rufus|Ventoy - Ventoy from ventoy.net; GUI alt: 'popsicle'"
  "SpotPlayer|SpotPlayer (Linux) - SpotPlayer (Sib) Linux build from sibm[a].ir"
  "VMware Workstation|VMware Workstation Pro (Linux) - VMware Workstation Pro .bundle (free for personal use)"
  "WindTerm|WindTerm (Linux) - WindTerm from GitHub releases"
)
